...
def test_all_phase9_capabilities_registered_and_structured() -> None:
    """Assert all 12 Phase 9 capabilities are registered with strict structure."""
...
def test_tool_schema_auto_derivation_discovers_phase9_capabilities() -> None:
    """Assert tool schema generator automatically discovers Phase 9 capabilities."""
    ...
    for cap_id in ALL_PHASE9_CAPABILITIES:
        ...
        assert sanitized_name in openai_tool_names, (
            f"Auto-generated OpenAI tool schemas missing Phase 9 capability '{sanitized_name}'"
        )

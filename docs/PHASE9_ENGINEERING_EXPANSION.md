...
## 6. المرحلة 9b — عقود وتكاملات المناقصات (Tender & BOQ Traceability)

| # | اسم القدرة المعيارية (Capability ID) | فئة الخطة والسلطة | الغرض الحسابي والمستندي الدقيق |
|---|--------------------------------------|------------------|------------------------------|
...
4. **أداء النواة p95:** زمن الاستجابة لجميع قدرات المناقصات أقل من $250\text{ ms}$ (المتوسط الفعلي $< 2\text{ ms}$).

...
# Keep existing imports above for backward compat; reduce __all__ to curated types.
# All 130+ internal names remain importable via their original module paths:
#   from fireai.core.floor_analyser import FloorAnalyser   # always works
#   from fireai.core import FloorAnalyser                   # still works (in __dict__)
# Only `from fireai.core import *` is restricted.
# Facade entry points (Engine, Placement, Safety) live in fireai/__init__.py

__all__ = [
    # === Core domain types (most commonly used) ===
    "AuditStore",
    "AuditTrail",
    "BuildingAnalysis",
    "BuildingEngine",

...
RULE_CEILING_HEIGHT_EXCEEDS_TABLE = Rule(
    ...
    fact_type="room",
    condition=lambda f: "ceiling_height_m" in f.properties
...
RULE_DEAD_AIR_SPACE = Rule(
    ...
    fact_type="detector",
    condition=lambda f: "distance_to_wall_m" in f.properties
...
RULE_DETECTOR_SPACING_VIOLATION = Rule(
    ...
    fact_type="detector",
    condition=lambda f: "x" in f.properties
    and "y" in f.properties

    ...
    def _define_rules(self) -> list[ComplianceRule]:
        ...
        return [
            ...
            ComplianceRule(
                ...
                validator=lambda ctx: ctx.get("spacing_m", float("inf"))
            ...
            ComplianceRule(
                ...
                validator=lambda ctx: ctx.get(
                    "v_drop_total_percent", ctx.get("v_drop_percent", 100)
                )
                <= 5.0,
            ...
            ComplianceRule(
                ...
                validator=lambda ctx: ctx.get("design_pressure_pa", 100) >= 25.0

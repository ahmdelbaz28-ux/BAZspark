...
const AskAiButton = lazy(() =>
	import("@/components/ai/AskAiButton").then((m) => ({
		default: m.AskAiButton,
	})),
);
...
const MagneticCursor = lazy(() =>
	import("@/components/interaction/MagneticCursor").then((m) => ({
...
const AutoCADDrawPage = lazy(() =>
	import("./pages/AutoCADDrawPage").then((m) => ({
		default: m.AutoCADDrawPage,
	})),
);
...
const CADSettingsPage = lazy(() =>
	import("./pages/CADSettingsPage").then((m) => ({
		default: m.CADSettingsPage,
	})),
);
...
const DigitalTwinPage = lazy(() =>
	import("./pages/DigitalTwinPage").then((m) => ({
...
const EngineeringPage = lazy(() =>
	import("./pages/EngineeringPage").then((m) => ({
		default: m.EngineeringPage,
	})),
);
...
const RevitCreatePage = lazy(() =>
	import("./pages/RevitCreatePage").then((m) => ({
		default: m.RevitCreatePage,
	})),
);
...
const SelfHealingPage = lazy(() =>
	import("./pages/SelfHealingPage").then((m) => ({
		default: m.SelfHealingPage,
	})),
);
...
const ExperimentalServicesPage = lazy(() =>
	import("./pages/ExperimentalServicesPage").then((m) => ({
		default: m.ExperimentalServicesPage,
	})),
);
...
const EngineeringFireAIPage = lazy(() =>
	import("./pages/EngineeringFireAIPage").then((m) => ({
		default: m.EngineeringFireAIPage,
	})),
);
const PipelineLayersPage = lazy(() =>
	import("./pages/PipelineLayersPage").then((m) => ({
		default: m.PipelineLayersPage,
	})),
);
const QOMNCalculatorPage = lazy(() =>
	import("./pages/QOMNCalculatorPage").then((m) => ({
		default: m.QOMNCalculatorPage,
	})),
);
...
const EngineeringCopilotPage = lazy(() =>
	import("./pages/EngineeringCopilotPage").then((m) => ({
		default: m.EngineeringCopilotPage,
	})),
);
...
const SecurityAlertsPage = lazy(() =>
	import("./pages/SecurityAlertsPage").then((m) => ({
 ...
 */
function App() {
	const [deprecationBannerDismissed, setDeprecationBannerDismissed] =
		useState(false);

		...
		>
			...
			<div
				...
				style={{
					...
					transform: reducedMotion
						? "none"
						: "perspective(1000px) rotateY(-12deg) rotateX(8deg)",
					transformOrigin: "center center",
				}}
			>
...
function GridFloor({
	...
	// NOSONAR — S6759: Props read-only pattern intentional for decorative components
	return (
		<svg
...
function AutoCAD2DPlan({ reducedMotion }: { reducedMotion: boolean }) {
	// NOSONAR — S3776, S6759: Cognitive complexity acceptable for decorative SVG; props pattern intentional
	return (
		<svg
			width="100%"
			height="100%"
		...
		>
			...
			<g className={reducedMotion ? "" : "cad-fade-1"}>
				...
				/>
				<path
					d="M 195 60 A 20 20 0 0 1 215 80 M 195 60 L 195 80"
					fill="none"
					stroke="#22c55e"
					strokeWidth="1.2"
				/>
				...
				/>
				<path
					d="M 265 180 A 20 20 0 0 1 285 200 M 265 180 L 265 200"
					fill="none"
					stroke="#22c55e"
					strokeWidth="1.2"
				/>
				...
				/>
				<path
					d="M 175 220 A 20 20 0 0 0 195 240 M 175 220 L 195 220"
					fill="none"
					stroke="#22c55e"
					strokeWidth="1.2"
				/>
				...
				/>
				<path
					d="M 240 290 A 30 30 0 0 0 270 260 M 240 290 L 240 260"
					fill="none"
					stroke="#22c55e"
					strokeWidth="1.4"
				/>
			...
			<g className={reducedMotion ? "" : "cad-fade-2"} filter="url(#cadGlow)">
				...
				<circle
					...
					cy="120"
					r="32"
					fill="url(#smokeCoverage)"
					className={reducedMotion ? "" : "cad-pulse-1"}
				/>
				<circle
					cx="140"
					cy="120"
				...
				<circle
					...
					r="32"
					fill="url(#smokeCoverage)"
					className={reducedMotion ? "" : "cad-pulse-2"}
				/>
				<circle
					cx="190"
					cy="150"
				...
				<circle
					...
					r="32"
					fill="url(#smokeCoverage)"
					className={reducedMotion ? "" : "cad-pulse-3"}
				/>
				<circle
					cx="275"
					cy="120"
							...
							fill={
								n.layer === 0
									...
									: n.layer === 3
										? "#22c55e"
										: "#a855f7"
							} // NOSONAR — S3358: Nested ternary is intentional for color logic in SVG
						/>
						{/* Ring */}
						<circle
							cx={n.x}
...
function Revit3DBuilding({ reducedMotion }: { reducedMotion: boolean }) {
	...
	return (
		...
		>
			...
			{/* NOSONAR — S7773 */}
			<circle
				cx={Number.parseFloat(iso(120, 0, 28).split(",")[0])}
				cy={Number.parseFloat(iso(120, 0, 28).split(",")[1])}
				r="1.5"
				fill="#fbbf24"
			/>
	...
	return (
		<>
			...
			>
				...
				<div style={{ marginTop: "4px", color: "rgba(168,85,247,0.6)" }}>
					◆ AI NEURAL ENGINE
				</div>
			...
			>
				...
				<div style={{ marginTop: "4px" }}>
					CONVERSION: <span style={{ color: "#22d3ee" }}>98.7%</span>
				</div>
			...
			>
				<div>
					COMMAND: <span className="cad-cursor-blink">_</span>
				</div>
				<div style={{ marginTop: "2px" }}>RECOGNIZE · PLACE · VERIFY</div>
				<div style={{ marginTop: "4px", color: "rgba(34,211,238,0.5)" }}>
					DETECTORS: 7 · HEAT: 1 · HORNS: 5
				</div>
				<div>
					FACP: <span style={{ color: "#22c55e" }}>ONLINE</span>
				</div>
			</div>
		</>
	);

...
const COMMANDS: CommandItem[] = [
	...
	{
		id: "cmd-qomn",
		label: "QOMN Calculations (NFPA Spacing / Battery)",
		shortcut: "G Q",
		category: "navigation",
	...
	{
		id: "cmd-facp",
		label: "FACP Multi-Agent Pipeline",
		shortcut: "G A",
		category: "navigation",
		path: "/facp",
	},
	...
	{
		id: "cmd-topology",
		label: "Circuit & Element Topology",
		category: "navigation",
		path: "/engineering/topology",
	},
	{
		id: "cmd-devices",
		label: "Device Inventory & Status",
		category: "navigation",
		path: "/devices",
	},
	{
		id: "cmd-audit-trail",
		label: "Audit Trail (SHA-256 Chain)",
		category: "navigation",
		path: "/audit-trail",
	},
	{
	...
	},
	{
		...
		label: "Run Code Compliance Check",
		shortcut: "N K",
		category: "action",
		path: "/engineering",
	},

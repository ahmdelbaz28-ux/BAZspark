		...
		shortcuts: [
			{
				...
				defaultLabel: "Go to Dashboard",
			},
			{
				keys: ["G", "P"],
				labelKey: "shortcuts.projects",
				defaultLabel: "Go to Projects",
			},
			{
				keys: ["G", "E"],
				labelKey: "shortcuts.engineering",
				defaultLabel: "Go to Engineering",
			},
			{
				keys: ["G", "S"],
				labelKey: "shortcuts.settings",
				defaultLabel: "Go to Settings",
			},
			{
				keys: ["G", "R"],
				labelKey: "shortcuts.reports",
				defaultLabel: "Go to Reports",
			},
			{
				keys: ["G", "F"],
				labelKey: "shortcuts.fireAlarm",
				defaultLabel: "Go to Fire Alarm Designer",
			},
			{
				keys: ["G", "T"],
				labelKey: "shortcuts.digitalTwin",
				defaultLabel: "Go to Digital Twin",
			},
		],
	},
	{
		...
		shortcuts: [
			{
				...
				defaultLabel: "Open Command Palette",
			},
			{
				keys: ["Ctrl+J"],
				labelKey: "shortcuts.aiCopilot",
				defaultLabel: "Toggle AI Copilot",
			},
			{
				keys: ["Ctrl+H"],
				labelKey: "shortcuts.help",
				defaultLabel: "Open Contextual Help",
			},
	...
	},
	{
		...
		shortcuts: [
			...
			},
			{
				...
				defaultLabel: "Focus Search / Command Palette",
			},
			{
				keys: ["Esc"],
				labelKey: "shortcuts.close",
				defaultLabel: "Close Modals / Panels",
			},
			{
				keys: ["↑", "↓"],
				labelKey: "shortcuts.navigate",
				defaultLabel: "Navigate Results",
			},
			{
				keys: ["Enter"],
				labelKey: "shortcuts.select",
				defaultLabel: "Select / Confirm",
			},
		],
	},
];

function ShortcutKey({ children }: { readonly children: string }) {
	const isMac =
						...
						<div>
							...
							<DialogDescription className="text-sm text-muted-foreground mt-0.5">
								{t(
									...
									"Press keys to navigate and control the application",
								)}
							</DialogDescription>
						</div>
					</div>

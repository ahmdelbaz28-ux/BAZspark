...
export function InteractiveCanvas() {
        ...
        // Stable monotonic counter for cable IDs (react-hooks/purity: avoid Date.now()
        // in the component body so the render stays pure).
        const cableIdCounterRef = useRef(0);
        ...
        const handleDeviceMouseUp = (e: React.MouseEvent, id: string) => {
                ...
                const newCable: CanvasElement = {
                        id: `cable-${cableIdCounterRef.current++}`,
                        type: "cable",
                        from: drawingFrom,
                        to: id,
                        x: 0,

...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: "nav.engineeringFireAI",  label: "FireAI",    icon: BellRing,    path: "/engineering/fireai" },
      { labelKey: "nav.pipelineLayers",     label: "Pipeline",  icon: Layers2,     path: "/engineering/pipeline" },
      { labelKey: "nav.topology",           label: "Topology",  icon: GitBranch,   path: "/engineering/topology" },
      { labelKey: "nav.bms",               label: "BMS",       icon: Monitor,     path: "/bms" },
    ],
  },
  {
    key: "cad",
    ...
    items: [
      ...
      { labelKey: "nav.cadTools",      label: "CAD Tools",      icon: PenLine,        path: "/cad-tools"  },
      { labelKey: "nav.aps",           label: "APS",            icon: Cpu,            path: "/aps"       },
      { labelKey: "nav.dwg",           label: "DWG",            icon: FileBarChart2,  path: "/dwg"       },
      { labelKey: "nav.bimProviders",  label: "BIM Providers",   icon: Building2,     path: "/bim-providers" },
      { labelKey: "nav.ifc43Mapping",  label: "IFC43",          icon: Globe,          path: "/ifc43-mapping" },
      { labelKey: "nav.arExport",      label: "AR Export",      icon: ShieldAlert,    path: "/ar-export" },
      { labelKey: "nav.sync",          label: "Sync",           icon: Repeat2,        path: "/sync"      },
      { labelKey: "nav.devices",       label: "Devices",        icon: Server,         path: "/devices"   },
    ],
  },
  {
    key: "environment",
    ...
    items: [
      ...
      { labelKey: "nav.environment",         label: "Overview",   icon: Cloud,        path: "/environment"         },
    ],
  },
  {
    key: "reporting",
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: "nav.memory",          label: "Memory",        icon: Brain,      path: "/memory" },
      { labelKey: "nav.graphrag",        label: "GraphRAG",      icon: Network,    path: "/graphrag" },
      { labelKey: "nav.workflow",        label: "Workflow",      icon: Repeat2,    path: "/workflow" },
      { labelKey: "nav.selfHealing",     label: "Self-Healing",  icon: Shield,     path: "/self-healing" },
      { labelKey: "nav.fdsSimulation",   label: "FDS Sim",       icon: Server,     path: "/fds-simulation" },
      { labelKey: "nav.etap",            label: "ETAP",          icon: Bolt,       path: "/etap" },
      { labelKey: "nav.marine",          label: "Marine",        icon: Ship,       path: "/marine" },
      { labelKey: "nav.mining",          label: "Mining",        icon: Pickaxe,    path: "/mining" },
    ],
  },
  {
    key: "settings",
    ...
    items: [
      ...
      { labelKey: "nav.apiKeys",          label: "API Keys",        icon: Key,       path: "/api-keys" },
    ],
  },
];

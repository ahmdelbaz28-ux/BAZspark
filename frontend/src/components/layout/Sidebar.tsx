                ...
                >
                                ...
                                {navItems
                                        ...
                                        return (
                                                <div key={item.path} className="relative px-3 mb-1">
                                                        <Link
                                                                to={item.path}
                                                                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-[color,background-color,border-color,transform] duration-200 ${
                                                                        isActive
                        ...
                        <div className="border-t border-white/10 shrink-0 p-3">
                                {!collapsed && (
                                        ...
                                        >
                                                <Info aria-hidden="true" className="h-[18px] w-[18px] shrink-0" />

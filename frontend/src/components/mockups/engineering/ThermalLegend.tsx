...
export const MiniIndicator = memo(function MiniIndicator({
	...
	return (
		<div
			className={`
        ${sizeClasses[size]} rounded-full transition-[width,color,background-color,border-color] duration-300
	...
	return (
		<div className="flex items-center gap-2">
			...
			<div className="flex-1 h-2 bg-white/10 rounded-full overflow-hidden">
				<div
					className={`
            h-full rounded-full transition-[width,color,background-color,border-color] duration-300
            ${isCritical ? "animate-pulse" : ""}
          `}
					style={{
						width: `${percentage}%`,

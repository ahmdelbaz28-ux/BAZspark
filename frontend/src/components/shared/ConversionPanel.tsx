...
function resolveConversionType(
	...
	if (sourceFormat === "autocad" && targetFormat === "revit")
		return "autocad_to_revit";
	if (sourceFormat === "revit" && targetFormat === "autocad")
...
export function ConversionPanel() {
	...
	const [targetFormat, setTargetFormat] = useState<"revit" | "autocad" | "ifc">(
		"revit",
	);
	...
	const handleConvert = async () => {
		...
		try {
			...
			const res = await digitalTwinApi.convert({

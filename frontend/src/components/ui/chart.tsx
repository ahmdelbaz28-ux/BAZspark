...
// V214 MERGE FIX: recharts 3.x removed `payload` and `label` from Tooltip props.
// Use a permissive type so this component accepts what recharts passes at runtime.
...
// V214 MERGE FIX: recharts 3.x Legend no longer has `payload`/`verticalAlign` in props.
// Use a permissive type that accepts what recharts passes at runtime.

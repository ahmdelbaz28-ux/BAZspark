			...
			<div className="p-6 max-w-4xl mx-auto space-y-6">
						...
						<div className="space-y-3">
							...
							{submitMutation.isSuccess && (
								<div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-3">
									...
									<button
										type="button"
										onClick={() => setJobId(submitMutation.data.work_item_id)}
				...
				<div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
					<p className="text-xs text-slate-500">
						...
						automation. Upload your files to an Autodesk OSS bucket, then submit
						a WorkItem to process them with a Design Automation activity.
						Requires valid APS credentials configured on the server.
					</p>
				</div>
			</div>
		</div>

...
export function ARExportPage() {
	...
	const behindWallText =
		behindWallCount > 0 ? ` (${behindWallCount} behind walls)` : "";
		...
		<div className="flex-1 overflow-auto">
			<div className="p-6 max-w-4xl mx-auto space-y-6">
				...
				<div className="flex items-center gap-3">
					...
					<div>
						<h1 className="text-2xl font-bold text-foreground">AR Export</h1>
				...
				<Card className="border-border bg-card stagger-card">
					<CardHeader className="pb-3">
						...
						<CardDescription className="text-muted-foreground">
							Configure and export your building model for AR viewing on mobile
							devices
						</CardDescription>
					</CardHeader>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="space-y-2">
								...
								<p className="text-xs text-muted-foreground">
									{(() => {
										if (format === "glb")
											return "Compatible with WebXR, Three.js, and most AR platforms";
										if (format === "usdz")
											return "Native AR Quick Look on iOS/iPadOS devices";
				...
				<Card className="border-border bg-card stagger-card">
					<CardHeader className="pb-3">
						...
						<CardDescription className="text-muted-foreground">
							Calibrate 3D model alignment offsets (X, Y, Z) and pin physical
							site coordinates via QR Code anchor.
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						...
						<div className="flex items-center justify-between pt-2 border-t border-border">
							...
							<Button
								...
								onClick={() =>
									alert(
										"QR Code Anchor Pinned! Spatial model aligned with physical site origin.",
									)
								}
							>

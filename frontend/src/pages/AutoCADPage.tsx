				...
				>
					...
					<div className="space-y-1">
						...
						<p className="text-xs text-amber-200">
							...
							write_dwg, save, delete_entity, modify_entity) will either return
							mock objects or fail with an honest error. No real DWG files will
							be created or modified. For real AutoCAD integration, install
							pywin32 + AutoCAD on Windows.
						</p>
					</div>
				</div>
			)}

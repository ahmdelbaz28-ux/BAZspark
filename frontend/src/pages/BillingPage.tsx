			...
			<div className="max-w-5xl mx-auto px-4">
				...
				<div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-500">
					...
					<div className="p-4 bg-white border border-slate-200 rounded-lg">
						...
						<p>
							Duplicate webhook deliveries are detected by a derived idempotency
							key and never re-fulfill an order. You will not be double-charged.
						</p>
					</div>
					<div className="p-4 bg-white border border-slate-200 rounded-lg">
						<h3 className="font-semibold text-slate-700 mb-1">
						...
						<p>
							...
							<code className="px-1">status = 'pending'</code> filter — only the
							first terminal webhook flips the order.
						</p>
					</div>
				</div>
			</div>

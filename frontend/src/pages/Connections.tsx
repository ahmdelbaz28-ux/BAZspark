		...
		<div className="space-y-6" aria-label={t("connectionsPage.title")}>
			...
			{deleteTarget && (
				<dialog
					...
					open
					aria-modal="true"
					aria-label={t("connectionsPage.deleteConnection")}
				>
...
function EditConnectionModal({
	...
	const [isParametric, setIsParametric] = useState(
		connection.is_parametric || false,
	);

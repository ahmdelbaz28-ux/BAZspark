      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Upload AutoCAD DWG or DXF files to extract structured building
            data — rooms, layers, and geometry
          </p>
        </div>
        ...
        <div className="bg-slate-800/30 border border-slate-700/50 rounded-lg p-4">
          <p className="text-xs text-slate-500">
            ...
            building geometry from AutoCAD drawings. Parsed data can be used
            for fire safety analysis, egress calculations, and digital twin

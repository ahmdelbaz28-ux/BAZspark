...
const translations = {
        en: {
                ...
                heroTitle: "The World's Most Advanced AI-Powered Fire Safety Engineering Platform.",
                heroSubtitle:
                ...
                feature2Desc: "Live safety rule engine tracking NFPA 72 & SOLAS 2024 standards.",
                feature3Title: "Digital Twin & BIM",
                feature3Desc: "High-fidelity 3D visualization and building information modeling.",
                feature4Title: "AI Engineering Agent",
                feature4Desc: "Proactive self-healing systems and predictive risk analysis.",
                feature5Title: "Marine SOLAS & IMO Compliance",
                feature5Desc: "Specialized fire safety for maritime vessels and offshore platforms.",
                ...
                supportDesc: "Need help acquiring an Engineering Key or connecting your Revit/AutoCAD workstation?",
                ...
                requestDesc: "Engineering Keys are granted to certified life-safety designers, CAD operators, and enterprise partners.",
        ...
        ar: {
                ...
                heroTitle: "المنصة الأكثر تطوراً عالمياً للهندسة الوقائية والسلامة من الحرائق بالذكاء الاصطناعي.",
                heroSubtitle:
                ...
                feature1Desc: "التوزيع الذكي لكواشف الحريق وتوجيه المسارات المثالية للكابلات.",
                ...
                feature5Desc: "أنظمة حماية متخصصة للسفن البحرية والمنصات التابعة للقطاع البحري.",
                ...
                supportDesc: "هل تحتاج إلى مساعدة في الحصول على مفتاح ترخيص أو ربط محطة عمل Revit/AutoCAD؟",
                supportDocsBtn: "عرض دليل مفاتيح API",
                supportEmail: "الدعم المباشر: support@bazspark.com",
                closeBtn: "إغلاق",
                // Request Access Modal
                requestTitle: "طلب مفتاح ترخيص مهندسي",
                requestDesc: "يتم منح مفاتيح الترخيص للمهندسين المعتمدين والمشغلين والشركاء المؤسسيين.",
...
export function LoginPage() {
        ...
        const handleSubmit = async (e: FormEvent) => {
                ...
                if (!apiKey.trim()) {
                        setError(lang === "ar" ? "يرجى أدخال مفتاح الترخيص الخاص بك." : "Please enter your authorization key.");
                        return;
                }
                ...
                try {
                        if (remember) {
                                try {
                                        sessionStorage.setItem("fireai_remember", JSON.stringify({ remember: true }));
                                } catch {
        ...
        const variantProps = { lang, t, apiKey, setApiKey, showKey, setShowKey, remember, setRemember, submitting, error, isSuccess, showSupportModal, setShowSupportModal, showRequestModal, setShowRequestModal, handleSubmit, handleAutoFillTestKey, toggleLanguage };

...
import { Brain, History, Loader2, Plus, Search, Trash2 } from "lucide-react";
...
export function MemoryPage() {
	...
	const [historyResult, setHistoryResult] = useState<Record<
		string,
		unknown
	> | null>(null);
			...
			<div className="p-6 max-w-5xl mx-auto space-y-6">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						Store and retrieve engineering decisions, preferences, and learned
						patterns
					</p>
				</div>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Store a decision, preference, or learned pattern
						</CardDescription>
					</CardHeader>
					<CardContent>

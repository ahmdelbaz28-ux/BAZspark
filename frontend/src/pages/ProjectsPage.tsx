			...
			<div className="p-6 max-w-4xl mx-auto space-y-6">
				...
				<div className="flex flex-wrap items-center gap-3">
					<Select value={statusFilter} onValueChange={setStatusFilter}>
						<SelectTrigger
							className="w-[180px] bg-card border-border text-white stagger-card"
										...
										<div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-border">
											<Button
												...
												onClick={async () => {
													try {
														...
														toast.error(
															`DXF export failed: ${err instanceof Error ? err.message : "Unknown"}`,
														);
													}
												}}
											>
											...
											<Button
												...
												onClick={async () => {
													try {
														await apiCall(
															`/projects/${project.id}/export/revit`,
														);
														toast.success("Revit exported");
													} catch (err) {
														toast.error(
															`Revit export failed: ${err instanceof Error ? err.message : "Unknown"}`,
														);
													}
												}}
											>
											...
											<Button
												...
												onClick={async () => {
													try {
														...
														toast.error(
															`IFC export failed: ${err instanceof Error ? err.message : "Unknown"}`,
														);
													}
												}}
											>

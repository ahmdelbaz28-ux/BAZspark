				...
				<div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4 space-y-3">
					...
					<div className="space-y-2 text-xs text-slate-400 leading-relaxed">
						<p>
							...
							sync scans all devices and connections associated with the
							selected project and updates the sync status. It performs a
							database consistency check to ensure all records are accounted
							for.
						</p>
						<p>
							<strong className="text-slate-300">Real-time updates:</strong>{" "}
							Sync completion events are broadcast via WebSocket to all
							subscribed clients. Open the WebSocket connection at{" "}
							<code className="text-cyan-300">/ws</code> and subscribe to the
							project to receive live updates.
						</p>
						<p>
							<strong className="text-slate-300">External BIM sync:</strong> For
							synchronization with external BIM systems (Revit, AutoCAD), use
							the IFC pipeline at the Digital Twin Convert page.
						</p>
					</div>
				</div>
			</div>

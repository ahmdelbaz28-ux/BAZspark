...
describe("AnalysisPage", () => {
	...
	it("shows battery capacity results after successful battery analysis", async () => {
		...
		await waitFor(() => {
			expect(screen.getByText("Battery Capacity Results")).toBeInTheDocument();
	...
	it("shows voltage drop results after successful voltage analysis", async () => {
		...
		await waitFor(() => {
			expect(screen.getByText("Voltage Drop Results")).toBeInTheDocument();
	...
	it("shows error message on analysis failure", async () => {
		...
		await waitFor(() => {
			expect(screen.getByText("Invalid load value")).toBeInTheDocument();
		});
	});

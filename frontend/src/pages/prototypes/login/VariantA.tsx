...
function _deriveAlarmAriaLabel(
	error: string | null,
	submitting: boolean,
	isSuccess: boolean,
	lang: string,
...
export function VariantA(props: Readonly<LoginVariantProps>) {
	...
	const alarmAriaLabel = _deriveAlarmAriaLabel(
		error,
		submitting,
		isSuccess,
		lang,
	...
	const features = [
		{
			icon: <Compass style={{ width: "1.25rem", height: "1.25rem" }} />,
			cls: "icon-box-cad",
			title: t.feature1Title,
			desc: t.feature1Desc,
		},
		{
			icon: <ShieldCheck style={{ width: "1.25rem", height: "1.25rem" }} />,
			cls: "icon-box-compliance",
			title: t.feature2Title,
			desc: t.feature2Desc,
		},
		{
			icon: <Layers style={{ width: "1.25rem", height: "1.25rem" }} />,
			cls: "icon-box-bim",
			title: t.feature3Title,
			desc: t.feature3Desc,
		},
		{
			icon: <Bot style={{ width: "1.25rem", height: "1.25rem" }} />,
			cls: "icon-box-ai",
			title: t.feature4Title,
			desc: t.feature4Desc,
		},
		{
			icon: <Anchor style={{ width: "1.25rem", height: "1.25rem" }} />,
			cls: "icon-box-marine",

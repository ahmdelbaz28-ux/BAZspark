...
test("login page renders with correct elements", async ({ page }) => {
        ...
        await expect(page.getByText(/ENGINEERING INTELLIGENCE/i)).toBeVisible({ timeout: 15000 });
        ...
        const signInButton = page.getByRole("button", { name: /INITIALIZE SECURE SESSION/i });

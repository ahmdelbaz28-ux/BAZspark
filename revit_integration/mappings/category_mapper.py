...
class CategoryMapper:
    ...
    def map_category_to_attributes(self, revit_category: str) -> dict[str, Any]:
        ...
        attributes = {
            ...
            "is_electrical": "electrical" in revit_category.lower()
            or any(equip in revit_category.lower() for equip in ["panel", "transformer", "switch"]),
            "is_spatial": revit_category.lower() in ["rooms", "spaces", "areas"],
            "requires_gis": revit_category.lower()
            in ["rooms", "spaces", "areas", "doors", "windows", "walls"],
    ...
    def transform_for_etap(self, revit_element_data: dict[str, Any]) -> dict[str, Any]:
        ...
        transformed_params = self._transform_parameters(
            revit_element_data.get("parameters", {}), equipment_type
        )
        ...
        etap_element = {
            ...
            "category": category,
            "etap_model_type": etap_attributes["etap_model_type"].value
            if etap_attributes["etap_model_type"]
            else "Unknown",
    ...
    def _transform_parameters(
        self, parameters: dict[str, Any], _equipment_type: str
    ) -> dict[str, Any]:
        """

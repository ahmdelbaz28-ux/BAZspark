...
class TestHarmonicAnalysis:
    ...
    def test_default_harmonics_match_6_pulse_vfd(self):
    ...
    def test_thd_current_calculation_correct(self):
    ...
    def test_isc_il_ratio_calculation(self):
    ...
    def test_tdd_limit_lookup_correct(self):
    ...
    def test_voltage_limit_5pct_for_low_voltage(self):
        """IEEE 519 Table 1: THD_V < 5% for systems ≤ 69 kV."""
        assert IEEE_519_VOLTAGE_LIMIT_PCT == 5.0

    def test_compliance_flags_set_correctly(self):
    ...
    def test_no_resonance_when_no_capacitor(self):
    ...
    def test_warnings_for_non_compliance(self):
...
class TestTransientStability:
    ...
    def test_initial_rotor_angle_calculation(self):
    ...
    def test_max_rotor_angle_is_pi_minus_delta_0(self):
    ...
    def test_critical_clearing_angle_within_valid_range(self):
    ...
    def test_cct_positive_for_stable_system(self):
        """CCT must be positive when P_m < P_e_max."""
        result = simulate_transient_stability()
        assert result.critical_clearing_time_s > 0

    def test_cct_increases_with_higher_inertia(self):
    ...
    def test_cct_decreases_with_higher_loading(self):
    ...
    def test_unstable_when_pm_exceeds_pe_max(self):
    ...
    def test_stability_flag_true_when_clearing_below_cct(self):
        """is_stable = True when actual_clearing_time < CCT."""
        result = simulate_transient_stability(actual_clearing_time_s=0.05)
        assert result.is_stable is True

    def test_stability_flag_false_when_clearing_above_cct(self):
    ...
    def test_marginal_warning_near_cct(self):
    ...
    def test_50hz_system_supported(self):
...
class TestCrossSimulationConsistency:
    ...
    def test_all_7_simulations_in_run_all(self):
    ...
    def test_all_simulations_have_assumptions(self):

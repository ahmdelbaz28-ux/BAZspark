...
class DuctDetectorPlacementSystem:
    ...
    def _place_duct_detectors(self, duct: HVACDuct) -> List[Device]:
        ...
        # Note: Using SMOKE_DETECTOR as DUCT_DETECTOR (NFPA 72 allows smoke detectors in ducts)
...
def get_coverage_report(
    ...
    duct_detectors = [d for d in devices if d.device_type == DeviceType.SMOKE_DETECTOR]

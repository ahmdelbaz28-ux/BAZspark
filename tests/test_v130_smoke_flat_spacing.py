...
class TestQomnKernelSmokeFlatSpacing:
    ...
    def test_high_ceiling_stratification_advisory(self):
        ...
        assert (
            "stratification" in result.audit_notice.lower() or "17.7.1.11" in result.audit_notice
    ...
    def test_low_ceiling_no_advisory(self):
        ...
        assert result.audit_notice is None, "Stratification advisory should not appear at h<=6.096m"
